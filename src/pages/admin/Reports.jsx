    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Card>
          ...
          <CardContent>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              Download a detailed report of all student activities, progress,
              and enrollments.
            </p>
            <Button
              variant="primary"
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              Get insights about course enrollments, completion rates, and
              ratings.
            </p>
            <Button
              variant="primary"
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              View submission statistics, grades distribution, and pending
              reviews.
            </p>
            <Button
              variant="primary"
              onClick={() => generateReport("assignment")}
              fullWidth
            >
              <Download size={18} className="mr-2" />
              Download Report
